...
class SuGaR(nn.Module):
    ...
    def drop_low_opacity_points(self, opacity_threshold=0.5):
        ...
        if n_mask > 0:
            ...
            print('Too small opacity. force to set opacity 0.9')
            self.all_densities = torch.nn.Parameter(self.all_densities.detach()+0.9, requires_grad=False) # no way to overcome low opacity. just set 0.9
